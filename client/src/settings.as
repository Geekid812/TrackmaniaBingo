namespace Settings {
    ...
    BackendConfiguration LOCALHOST_BACKEND = BackendConfiguration("localhost", 5000);

    BackendConfiguration LIVE_BACKEND = BackendConfiguration("vmi1095534.contaboserver.net", 5000);
