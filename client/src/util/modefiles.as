...
namespace Modefiles {
    void EnsureAllModefilesCreated() {
        CreateBingoModescriptFiles();
    }

    void CreateBingoModescriptFiles() {
        CreateFile("data/Bingo_PlayMap_Local.Script.txt", "Scripts/Modes/TrackMania/Bingo_PlayMap_Local.Script.txt");
    ...
    bool AreModefilesInstalled() {
        return IO::FileExists(IO::FromUserGameFolder("Scripts/Modes/TrackMania/Bingo_PlayMap_Local.Script.txt"));
    }
}
